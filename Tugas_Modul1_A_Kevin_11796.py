...
model_directory = r'D:\Nicolaus Kevin PH\SEMS 5\ML\Pert 2\Tugas_A_11796'
...
if os.path.exists(model_path):
    try:
        ...
        glucose = st.slider("Glucose (mg/dt)", min_value = 0.0, max_value = 199.0, step=0.1)
        ...
        insulin = st.slider("Insulin (mL)", min_value=0, max_value=846, step=10)
